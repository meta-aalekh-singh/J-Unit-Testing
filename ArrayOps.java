...
public class ArrayOps {
	 ...
	 * @return max (maximum value mirrored)
	 */
	...
	/*
	 * Split Array in such a manner that sum of left and right array is equal
	 * @param arr:Array Input
	...
	public static void main(String...arg)
	{
		...
		ArrayOps aop1=new ArrayOps();
		System.out.println("The Largest mirror number : "+aop1.largestMirror(arr1));
		System.out.println("The Number of clumps : "+aop1.countClumps(arr2));
		System.out.println("the array should split at : "+aop1.splitArray(arr3));
